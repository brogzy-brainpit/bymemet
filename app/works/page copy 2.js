  ...
  let templates = [];
    ...
    return (
        ...
        <div className='flex gap-3 flex-wrap items-center justify-center '>
          <h2 className='text-heading text-white'>hello</h2>
         <Suspense fallback={<LoadingSkeleton />}>
        <TemplateLists templates={templates}/>
      </Suspense>
...
const LoadingSkeleton=({templates})=>{
  return (
<div className='h-screen bg-purple-500 flex '>
  skeleton
</div>
  )
}
