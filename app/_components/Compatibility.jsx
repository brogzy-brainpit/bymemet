...
function Compatibility() {
  ...
  return (
    <div className='container grid-imgs py-6'>
        ...
        <p className='font-body t-medium t-align-center'>{"my email templates are compatible with Klaviyo, Mailchimp, Campaign Monitor + 28 Email Service Providers. Simply integrate my email template to your preferred Email Service Provider."}</p>
            {compImg.map((e,index)=>{
                return (
