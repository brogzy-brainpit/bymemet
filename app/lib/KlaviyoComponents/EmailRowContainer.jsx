...
function EmailRowContainer({styling,children,colRow,classes}) {
  return (
<table align='center' width="100%" style={{width: "100%"}} border="0" cellpadding="0" cellspacing="0" role="presentation" >
  ...
  <table valign={styling.verticalAlignment} align='center' className='w-ful' width={colRow?"100%":imagify(styling.width)} style={{width:colRow?"100%":styling.width}} border="0" cellpadding="0" cellspacing="0" role="presentation">
<tr>
  
      {styling.backgroundImage?`\n <!--[if !gte mso 9]><!-- --> \n`:""}
<td background={styling.backgroundImage} bgcolor={styling.backgroundfallback} className={classes}  style={{...check(styling,"col-container"),width:colRow?"100%":styling.width}} valign="top">
{styling.backgroundImage?`\n <!--<![endif]-->\n
<!--[if gte mso 9]>
...
export default EmailRowContainer